...
import smifflepuss.smifflemod.item.SmiffleModCatchableItem;
...
public class SmiffleModItems {
    ...
    public static final RegistryObject<Item> SOUL_SPAWN_EGG = ITEMS.register("soul_spawn_egg", () -> new ForgeSpawnEggItem(SmiffleModEntities.SOUL, 0x003399, 0x66CCFF, (new Item.Properties())));
    ...
    public static final RegistryObject<Item> BEAR_MEAT = ITEMS.register("bear_meat", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationMod(0.6F).effect(new MobEffectInstance(MobEffects.HUNGER, 600, 0), 0.3F).meat().build())));
    ...
    public static final RegistryObject<Item> COOKED_SEAHORSE = ITEMS.register("cooked_seahorse", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationMod(0.65F).meat().effect(new MobEffectInstance(MobEffects.REGENERATION, 100, 0), 0.3F).build())));
    public static final RegistryObject<Item> SOUL_ITEM = ITEMS.register("soul_item", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> SOUL_IN_A_BOTTLE = ITEMS.register("soul_in_a_bottle", () -> new SmiffleModCatchableItem(SmiffleModEntities.SOUL::get, Items.GLASS_BOTTLE, false, new Item.Properties().stacksTo(1)));
    ...
    public static void registerCreativeTabsItem(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.SPAWN_EGGS) {
            ...
            event.getEntries().putAfter(new ItemStack(SHROOMLING_SPAWN_EGG.get()), new ItemStack(SOUL_SPAWN_EGG.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }
        ...
        if (event.getTabKey() == CreativeModeTabs.FOOD_AND_DRINKS) {
            ...
            event.getEntries().putAfter(new ItemStack(Items.TROPICAL_FISH), new ItemStack(SEAHORSE_ITEM.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        ...
        if (event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            ...
            event.getEntries().putAfter(new ItemStack(Items.GHAST_TEAR), new ItemStack(SOUL_ITEM.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            event.getEntries().putAfter(new ItemStack(SOUL_ITEM.get()), new ItemStack(SOUL_IN_A_BOTTLE.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }
        if (event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
            event.getEntries().putAfter(new ItemStack(Items.TROPICAL_FISH_BUCKET), new ItemStack(SEAHORSE_BUCKET.get()), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }
    }
