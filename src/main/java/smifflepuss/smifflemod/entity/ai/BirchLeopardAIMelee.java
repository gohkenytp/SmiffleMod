package smifflepuss.smifflemod.entity.ai;
...
public class BirchLeopardAIMelee extends Goal {
    private final Mob mob;
    private LivingEntity target;
    private int attackTime;

    public BirchLeopardAIMelee(Mob p_25658_) {
        this.mob = p_25658_;
    ...
    public boolean canContinueToUse() {
        if (!this.target.isAlive()) {
            return false;
        } else if (this.mob.distanceToSqr(this.target) > 230.0D) {
            return false;
        } else {
